...
const ColorIcons: FC<Props> = ({
  ...
  const isChecked = (): boolean => {
    return selectedClothesColorList
      ? selectedClothesColorList.includes(color)
      : false;
  };

  const clickColor = () => {
    const colorExists: boolean = selectedClothesColorList
      ? selectedClothesColorList.includes(color)
      : false;
    const newColors = colorExists
      ? selectedClothesColorList.filter(
          (clothesColor) => clothesColor !== color
        )
